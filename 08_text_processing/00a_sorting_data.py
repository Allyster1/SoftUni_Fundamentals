class TextProcessor:
    def __init__(self, text):
        """Initialize the text processor ith user input"""
        self.text= text
...
def main():
    ...
    while True:
        ...
        choice = int(input("Choose an option (0-15): "))
        ...
        if choice == 1:
            ...
            sub_string = input("Enter substring to count: ")
            print('Occurrences:', processor.count_occurrences(sub_string))
        elif choice == 9:
            ...
            print('IS alphanumeric?:', processor.check_if_alphanum())
        elif choice == 13:
